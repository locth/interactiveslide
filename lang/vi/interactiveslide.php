...
$string['exportdeck'] = 'Xuất bộ slide';
$string['importdeck'] = 'Nhập bộ slide';
$string['errornothingtoexport'] = 'Chưa có slide nào để xuất.';
$string['errorexportfailed'] = 'Không tạo được tệp bộ slide.';
$string['errornotadeck'] = 'Tệp này không phải là tệp xuất bộ slide của Interactive Slide.';
$string['errordeckversion'] = 'Bộ slide này được xuất bởi phiên bản plugin mới hơn (định dạng {$a}). Hãy cập nhật Interactive Slide trên site này rồi thử lại.';
$string['errordeckempty'] = 'Tệp bộ slide này không chứa slide nào.';
$string['errordecktoolarge'] = 'Tệp bộ slide này khai báo hơn {$a} slide.';
$string['errordeckslidebroken'] = 'Không đọc được slide {$a} trong tệp bộ slide.';
$string['errordeckimage'] = 'Ảnh được khai cho slide {$a} không phải loại mà tệp bộ slide được phép chứa.';
$string['errordecktoomanytotal'] = 'Như vậy hoạt động sẽ có {$a->total} slide, trong khi giới hạn của site này là {$a->max}.';
$string['errordeckslide'] = 'Slide {$a->slide}: {$a->reason}';
$string['errorarchiveupload'] = 'Không tải lên được tệp bộ slide.';
$string['errorarchivetoolarge'] = 'Tệp này lớn hơn mức site cho phép ({$a}).';
$string['errorposttoolarge'] = 'Dữ liệu tải lên lớn hơn mức máy chủ cho phép. Hãy nhờ quản trị viên tăng post_max_size, hoặc nhập một bộ slide nhỏ hơn.';
$string['errorinvalidmode'] = 'Hãy chọn thay thế bộ slide hay thêm vào bộ hiện có.';
$string['notadeckfile'] = 'Tệp này không phải tệp xuất bộ slide. Hãy chọn tệp .zip bạn đã tải về bằng nút Xuất bộ slide.';
$string['importmode'] = 'Hoạt động này đã có slide';
$string['importmode_desc'] = '{$a->file} chứa {$a->slides} slide. Vậy {$a->existing} slide đang có sẽ xử lý thế nào?';
$string['importreplace'] = 'Thay thế toàn bộ {$a} slide';
$string['importappend'] = 'Thêm vào cuối';
$string['importcancel'] = 'Hủy';
$string['importingdeck'] = 'Đang nhập bộ slide';
$string['deckimported'] = 'Đã nhập {$a} slide';
$string['deckimportedwarnings'] = 'Đã nhập {$a->slides} slide, trong đó {$a->warnings} slide có vấn đề';
$string['deckrepriced'] = 'Site này có mức sao khác, nên các câu hỏi đã được tính lại số sao theo mức của site.';
$string['decksessionrunning'] = 'Hoạt động này đang có một phiên diễn ra. Nhập bộ slide sẽ thay đổi thứ cả phòng đang xem.';
$string['eventdeckexported'] = 'Đã xuất bộ slide';
$string['eventdeckimported'] = 'Đã nhập bộ slide';
