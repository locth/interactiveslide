...
$string['notanimage'] = 'That file is not an image.';
$string['uploading'] = 'Uploading...';
$string['slideadded'] = 'Slide added at the end of the deck.';
$string['uploadfailed'] = 'The upload failed.';
$string['exportdeck'] = 'Export deck';
$string['importdeck'] = 'Import deck';
$string['errornothingtoexport'] = 'There are no slides to export yet.';
$string['errorexportfailed'] = 'The deck file could not be built.';
$string['errornotadeck'] = 'That file is not an Interactive Slide deck export.';
$string['errordeckversion'] = 'This deck was exported by a newer version of the plugin (format {$a}). Update Interactive Slide on this site, then try again.';
$string['errordeckempty'] = 'That deck file contains no slides.';
$string['errordecktoolarge'] = 'That deck file claims more than {$a} slides.';
$string['errordeckslidebroken'] = 'Slide {$a} in that deck file could not be read.';
$string['errordeckimage'] = 'The picture named for slide {$a} is not one this deck file may contain.';
$string['errordecktoomanytotal'] = 'That would leave {$a->total} slides in this activity, and the limit for this site is {$a->max}.';
$string['errordeckslide'] = 'Slide {$a->slide}: {$a->reason}';
$string['errorarchiveupload'] = 'The deck file could not be uploaded.';
$string['errorarchivetoolarge'] = 'That file is larger than this site accepts ({$a}).';
$string['errorposttoolarge'] = 'The upload was larger than this server accepts. Ask an administrator to raise post_max_size, or import a smaller deck.';
$string['errorinvalidmode'] = 'Choose whether to replace the deck or add to it.';
$string['notadeckfile'] = 'That file is not a deck export. Choose the .zip you downloaded with Export deck.';
$string['importmode'] = 'This activity already has slides';
$string['importmode_desc'] = '{$a->file} contains {$a->slides} slide(s). What should happen to the {$a->existing} already here?';
$string['importreplace'] = 'Replace all {$a} slides';
$string['importappend'] = 'Add to the end';
$string['importcancel'] = 'Cancel';
$string['importingdeck'] = 'Importing deck';
$string['deckimported'] = 'Imported {$a} slides';
$string['deckimportedwarnings'] = 'Imported {$a->slides} slides, {$a->warnings} with problems';
$string['deckrepriced'] = 'Star values differ on this site, so questions were re-priced to match it.';
$string['decksessionrunning'] = 'A session is running in this activity right now. Importing will change what the room is looking at.';
$string['eventdeckexported'] = 'Deck exported';
$string['eventdeckimported'] = 'Deck imported';
$string['importpdf'] = 'Import PDF';
$string['starsinactivity'] = 'Stars in this activity';
$string['starsincourse'] = 'Stars in this course';
$string['sessionsjoined'] = 'From {$a} session(s)';
$string['acrossactivities'] = 'Across {$a} activity/activities';
$string['joinsession'] = 'Start taking part';
$string['backtostars'] = 'Back to my stars';
$string['sessionlivenow'] = 'A session is running right now';
$string['myreports'] = 'My report';
$string['myreports_desc'] = 'This report shows your own results only.';
$string['deletesession'] = 'Delete this session';
$string['deletesession_confirm'] = 'Delete the session "{$a->name}"?';
$string['deletesession_desc'] = 'This removes every answer given in it and the {$a->stars} star(s) it awarded to {$a->participants} participant(s). Their totals for this activity and for the course drop accordingly. It cannot be undone.';
$string['deletesession_done'] = 'Session deleted along with the stars it awarded.';
$string['errordeleteactivesession'] = 'This session is still running. End it first, then delete it.';
...
$string['typedropdown'] = 'Dropdown';
$string['typevideo'] = 'Video';
$string['video'] = 'Video';
$string['novideo'] = 'No video has been set for this slide.';
$string['videourl'] = 'Video link';
$string['videourl_help'] = 'A YouTube or Vimeo link, or a direct link to an .mp4, .webm or .ogv file.';
$string['videourlplaceholder'] = 'https://www.youtube.com/watch?v=...';
$string['errorvideourl'] = 'That link cannot be embedded. Use a YouTube or Vimeo link, or a direct link to an .mp4, .webm or .ogv file.';
$string['errornosubmission'] = 'This interaction does not take an answer.';
$string['chooseanswer'] = 'Choose an answer...';
...
$string['positions'] = 'Dropdown positions';
$string['position'] = 'Position';
$string['gapshint'] = 'Write ___ (three underscores) in the question wherever a dropdown should stand. Each gap becomes one position, in order.';
$string['errorneedoneposition'] = 'Add at least one dropdown position.';
$string['errorpositionneedstwooptions'] = 'Position {$a} needs at least two choices.';
$string['errorpositionneedsanswer'] = 'Mark the correct choice for position {$a}, or turn off "This question has a correct answer".';
$string['errorpositiononecorrect'] = 'Position {$a} can only have one correct choice: a dropdown takes one answer.';
...
$string['pdfjsmissing'] = 'The PDF reader could not be loaded. Download pdfjs-<version>-dist.zip from github.com/mozilla/pdf.js/releases and copy build/pdf.mjs and build/pdf.worker.mjs into mod/interactiveslide/thirdparty/pdfjs/. If the files are already there, check that mod/interactiveslide/pdfjs.php can be reached: the plugin serves pdf.js through it so that a server which does not send a JavaScript MIME type for .mjs still works. See the README in that folder.';
...
$string['showresultscreen'] = 'Show result';
$string['hideresultscreen'] = 'Hide result';
...
$string['errorlatejoin'] = 'This session was already under way when you arrived, and this activity does not allow joining late.';
...
$string['privacy:metadata:session'] = 'A live session run on the deck.';
$string['privacy:metadata:session:createdby'] = 'The member of staff who started the session.';
$string['privacy:metadata:session:name'] = 'The name given to the session.';
$string['privacy:metadata:session:timecreated'] = 'When the session was started.';
$string['privacy:presenterpath'] = 'Sessions presented';
